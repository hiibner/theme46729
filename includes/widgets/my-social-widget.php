...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php foreach(array("Facebook", "Twitter", "Linkedin", "Feed", "Pinterest", "Delicious", "Youtube", "Google") as $network) : ?>
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'twitter' => '', 'twitter_label' => '', 'facebook' => '', 'facebook_label' => '', 'linkedin' => '', 'linkedin_label' => '', 'feed' => '', 'feed_label' => '', 'pinterest' => '', 'pinterest_label' => '', 'delicious' => '', 'delicious_label' => '', 'youtube' => '', 'youtube_label' => '', 'google' => '', 'google_label' => '', 'display' => 'icons', 'text' => '');
